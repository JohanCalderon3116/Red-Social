...
export const InputPublicar = () => {
  ...
  return (
    <div className="p-4 border-b border-gray-200 dark:border-gray-600">
        <input onClick={setStateForm} value={""} placeholder="Escribir nueva publicación..." type="text" className="w-full p-2 rounded focus:outline-none placeholder-bg-gray-500"/>
