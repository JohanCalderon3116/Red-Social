    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-lg w-full max-w-md p-6">
        ...
        <section className="flex flex-col items-center gap-3">
          ...
          <ImageSelectorFoto></ImageSelectorFoto>
        </section>
        <form action="" onSubmit={handleSubmit(mutate)}>
          <div className="mb-4">
            <input
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-800 "
              type="text"
              placeholder="Nombre"
              {...register("nombre", {
          ...
          <button
            type="submit"
            className="w-full bg-gray-200 text-gray-500 font-medium py-3 rounded-full hover:bg-violet-700/65 hover:text-white transition duration-200 cursor-pointer"
          >
            Guardar
          </button>
        </form>
